 ...
 * Falls back gracefully with a clear error message if structure is unexpected.
 *
 * For production use, install the 'xlsx' npm package (listed in package.json).
 * This file is the zero-dependency fallback for environments without npm access.
 */
